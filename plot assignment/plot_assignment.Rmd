...
#notes to myself
- make it clear that u are able to fiddle with a good and a bad plot
bad plot
value level low if many participant make it cluttered. 


not too basic somewehre in the middle like raincloud plots are nice
...
- pdf/png format of the plot
- the (made up data)
- the code


it doent have to be the same type for bad and good

example for datasets( we can also ask chatgpt )
osf.io
...
The Palmer Penguins dataset originates from a study conducted by Dr. Kristen Gorman with the Palmer Station, Antarctica, to examine the morphology of three penguin species - Adelie, Chinstrap, and Gentoo. In this plot i will use this parts of this dataset and focus on the difference in weight between the different species.
...
The legend, apart from being redundant, adding to the confusion. The use of 'geom_magnify' has been poorly implemented, as it overwrites data without magnifying any relevant or useful area of the plot.
